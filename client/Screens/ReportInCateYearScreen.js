...
const ReportInCateYearScreen = ({ route }) => {
    ...
    const fetchData = async (userId, categoryId, year) => {
        try {
            const response = await axios.get(`http://10.0.2.2:3000/getYearlyIncomeReport/${categoryId}`, {
                params: { userId, year }
            });
...
export default ReportInCateYearScreen;
